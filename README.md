...
<img src="https://discordapp.com/api/guilds/646732504744853518/widget.png?style=shield" alt="AquaDevs Discord"/>
 ...
 📜Description: You can create unlimited tags. It has a menu where you can select to buy or equip the tags. To give a player permission when buying a tag you can add the command to the plugin you are using. The default plugin I used is PurePerm / PureChat. 
